...
function thememount_header_slider(){
	$sliderWrapperStart = '<div class="thememount-slider-wrapper">';
...
function thememount_header_titlebar(){
	...
	if( is_page() ){ // Page
		...
		if ( have_posts() ){
			the_post();
			$adv_tbar_authorarc = isset( $howes['adv_tbar_authorarc'] ) ? $howes['adv_tbar_authorarc'] : 'Author Archives: ' ;
	...
	if( $hidetitlebar != 'on' ){
		...
		<div class="thememount-titlebar-wrapper entry-header <?php echo $e_class; ?> thememount-titlebar-bgimg-img<?php echo $bgimg; ?> thememount-titlebar-textcolor-<?php echo $titlebar_text_color; ?>" <?php echo $inlineCSS; ?>>
...
function thememount_team_social( $column='' ){
	...
	$socialcode = '';
	if($facebook!=''){   $socialcode .= '<li class="thememount-social-facebook"><a href="'.esc_url($facebook).'" title="Facebook"><i class="tmicon-fa-facebook"></i></a></li>'; }
	if($twitter!=''){    $socialcode .= '<li class="thememount-social-twitter"><a href="'.esc_url($twitter).'" title="Twitter"><i class="tmicon-fa-twitter"></i></a></li>'; }
	if($linkedin!=''){   $socialcode .= '<li class="thememount-social-linkedin"><a href="'.esc_url($linkedin).'" title="LinkedIn"><i class="tmicon-fa-linkedin"></i></a></li>'; }
	if($googleplus!=''){ $socialcode .= '<li class="thememount-social-gplus"><a href="'.esc_url($googleplus).'" title="Google+"><i class="tmicon-fa-google-plus"></i></a></li>'; }
	if($email!=''){      $socialcode .= '<li class="thememount-social-email"><a href="mailto:'.sanitize_email($email).'" title="Email"><i class="tmicon-fa-envelope-o"></i></a></li>'; }
	if($socialcode!=''){ $socialcode = '<div class="thememount-team-social-links"><ul>'.$socialcode.'</ul></div>'; }
