...
$sections[] = array(
	...
	'fields' => array(
		...
		/*array(
			...
			'title'    => __('Predefined Color Packages', 'howes'), 
			'subtitle' => __('These are set of different colour packages. This will change: <ul class="thememount-list"> <li>Topbar background color and text color</li> <li>Header background colours and text colors</li> <li>Skin color</li> <li>footer background colors and text colors</li> </ul>', 'howes'),
			//'default'  => '#e85e16',
			//'validate' => 'color',
			'customizer'=> false,
			//'compiler' => 'true',
...
$sections[] = array(
	...
	'fields' => array(
		...
		array(
			...
			'subtitle' => __('Upload own image that will be used as logo for the site', 'howes'),
			'compiler' => 'true',
			'default'  => array(
